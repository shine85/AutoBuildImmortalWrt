...
if [ -n "$CUSTOM_PACKAGES" ]; then
  ...
  if [ "$PROFILE" = "glinet_gl-mt3000" ]; then
    ...
    git clone --depth=1 https://github.com/soapmancn/luci-app-autoupdate.git /tmp/luci-app-autoupdate
    git clone --depth=1 https://github.com/sirpdboy/luci-app-kucat-config.git /tmp/luci-app-kucat-config
